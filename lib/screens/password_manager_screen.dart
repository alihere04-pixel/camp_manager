  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      try {
       ...
       _profiles =
    await MikroTikService.getProfiles();
...
if (!_profiles.contains('default')) {
  ...
  // silently ignore offline error
      ...
      if (fresh.isNotEmpty) {
        ...
        // deleted users ko cache se remove rakho
        final deleted =
            _cachedPasswords
                .where((oldUser) =>
            !fresh.any(
  ...
  Future<void> _deletePassword(String username) async {
    ...
    final success =
        await MikroTikService
            .deleteHotspotUser(username);
    ...
    if (success) {
      ...
      setState(() {
        ...
        _cachedPasswords.removeWhere(
              (user) =>
            user['name'] == username,
        );


        _filteredPasswords.removeWhere(
              (user) =>
            user['name'] == username,
        );
...
ScaffoldMessenger.of(context).showSnackBar(
  ...
  final success =
      await MikroTikService.deleteHotspotUser(username);
                ...
                return Card(
                  ...
                  ListTile(
                    ...
                    Checkbox(
                      ...
                      value:
                      _selectedUsers.contains(username),
                      ...
                      onChanged:(value){
                        ...
                        setState((){
                          ...
                          if(value==true){
                            ...
                            // ✅ FIX 4: Last user uncheck par selection mode exit
